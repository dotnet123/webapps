...
return;
            $("iframe.LRADMS_iframe").each(function () {

                var ifm = $(this).get(0);

                var subWeb = document.frames ? document.frames["iframepage"].document : ifm.contentDocument;
               // console.info("1"+ifm.height);
               // console.info("2"+subWeb.body.scrollHeight);
                if (ifm != null && subWeb != null) {
                //   ifm.height = subWeb.body.scrollHeight;


                   // console.info("3"+ifm.height);
                  //  console.info("4"+subWeb.body.scrollHeight);
                }
    ...
    <div id="content-wrapper" class="content-wrapper">
        <div class="content-tabs">
            ...
            <nav class="page-tabs menuTabs">
                <div class="page-tabs-content" style="margin-left: 0px;">
                    <a href="javascript:;" class="menuTab active" data-id="/admin/news/list">欢迎首页</a>
        ...
        <div class="content-iframe" style="overflow: hidden;">
            <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                <iframe class="LRADMS_iframe"  width="100%" height="100%" src="/admin/news/list" frameborder="0" data-id="default.html"></iframe>
            </div>
        </div>
    </div>
</div>
